...
public class BoardController  {
    ...
    public String update(@PathVariable(name = "id") Integer id, @ModelAttribute BoardDTO.UpdateDTO updateDTO) {
        // 1. 데이터 바인딩 방식 수정
        ...
        boardRepository.updateByIdJPA(id, updateDTO.getTitle(), updateDTO.getContent());
        // 6. 리다이렉트 처리
    ...
    // 5. 서비스 측  위임(직접 구현 ) -레퍼지토리 사용
//      boardRepository.updateJPQL(id, updateDTO.getTitle(), updateDTO.getContent());
