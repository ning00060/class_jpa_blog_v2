...
public class BoardRepository {
    ...
    @Transactional
    public void updateJPQL(Integer id, String title, String content) {
        em.createQuery("UPDATE Board b SET b.username=username, b.title = :title, b.content = :content WHERE b.id = :id")
